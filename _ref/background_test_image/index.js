...
function preload() {
  img_appium = loadImage("images/appium.png");
  img_cypress = loadImage("images/cypress.png");
  img_docker = loadImage("images/docker.png");
  img_github = loadImage("images/github.png");
  img_jenkins = loadImage("images/jenkins.png");
  img_js = loadImage("images/js.svg");
  img_jupyter = loadImage("images/jupyter.png");
  img_kicad = loadImage("images/kicad.png");
  img_nestjs = loadImage("images/nestjs.png");
  img_nextjs = loadImage("images/nextjs.png");
  img_nodejs = loadImage("images/nodejs.png");
  img_preact = loadImage("images/preact.png");
  img_python = loadImage("images/python.jpg");
  img_react = loadImage("images/react.png");
  img_voron = loadImage("images/voron.png");
  img_vscode = loadImage("images/vscode.png");
  img_vue = loadImage("images/vue.png");
}
