# please help to convert the below curl command into python requests

curl 'https://gptapi.apoidea.ai/v1/conversation/conversations/dcd53ae9-4aa6-4c00-a1f1-e535742954cd' \
    -X DELETE \
